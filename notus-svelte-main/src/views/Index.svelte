<script>
  ...
  const patternVue = "/assets/img/life-long-learning.png";
    ...
    <div class="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
      <div class="pt-32 sm:pt-0">
        <h2 class="font-semibold text-4xl text-blueGray-600">
          Sai-Edu-Dapp - A Decentralized Educational System.
        </h2>
        <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
          Make your Life Long Educational Experience a trustless and decentralized one, where your achievements will be rewarded with smart badges and credits which can be converted to real money.
          We provide a decentralized way for life long learning,not just learning,but students can earn from the credits they acheive.
        </p>
        <div class="mt-12">
          <a
            use:link
